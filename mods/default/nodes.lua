...
minetest.register_node("default:cobble", {
	...
	groups = {cracky = 3, stone = 2, snow_cover = 1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:stonebrick", {
	...
	is_ground_content = false,
	groups = {cracky = 2, stone = 1, snow_cover = 1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:obsidian", {
	...
	sounds = default.node_sound_stone_defaults(),
	groups = {cracky = 1, level = 2, snow_cover = 1},
})
...
minetest.register_node("default:dirt", {
	...
	groups = {crumbly = 3, soil = 1, snow_cover = 1},
...
minetest.register_node("default:dirt_with_grass_footsteps", {
	...
	tiles = {"default_grass.png^default_footprint.png", "default_dirt.png",
		{name = "default_dirt.png^default_grass_side.png",
			tileable_vertical = false}},
	groups = {crumbly = 3, soil = 1, not_in_creative_inventory = 1, snow_cover = 1},
	drop = 'default:dirt',
	sounds = default.node_sound_dirt_defaults({
		footstep = {name = "default_grass_footstep", gain = 0.25},
	}),
...
minetest.register_node("default:sand", {
	...
	groups = {crumbly = 3, falling_node = 1, sand = 1, snow_cover = 1},
...
minetest.register_node("default:gravel", {
	...
	groups = {crumbly = 2, falling_node = 1, no_snow_cover = 1},
	sounds = default.node_sound_dirt_defaults({
...
minetest.register_node("default:snow", {
	...
	groups = {crumbly = 3, falling_node = 1, puts_out_fire = 1, inert=1},
	sounds = default.node_sound_dirt_defaults({
		footstep = {name = "default_snow_footstep", gain = 0.25},
...
minetest.register_node("default:snowblock", {
	...
	tiles = {"default_snow.png"},
	paramtype = "light",
	groups = {crumbly = 3, puts_out_fire = 1, inert=1},
	sounds = default.node_sound_dirt_defaults({
		footstep = {name = "default_snow_footstep", gain = 0.25},
		dug = {name = "default_snow_footstep", gain = 0.75},
	}),
...
minetest.register_node("default:ice", {
	...
	is_ground_content = false,
	paramtype = "light",
	groups = {cracky = 3, puts_out_fire = 1, ice = 1,snow_cover = 1, slippery = 3},
...
minetest.register_node("default:tree", {
	...
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {tree = 1, choppy = 2, oddly_breakable_by_hand = 1, flammable = 2, snow_cover = 1},
...
minetest.register_node("default:wood", {
	...
	is_ground_content = false,
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 3, wood = 1, snow_cover = 1},
	sounds = default.node_sound_wood_defaults(),
})
...
minetest.register_node("default:diamondblock", {
	...
	is_ground_content = false,
	groups = {cracky = 1, level = 3, snow_cover = 1},
	sounds = default.node_sound_stone_defaults(),
})
...
minetest.register_node("default:cactus", {
	...
	paramtype2 = "facedir",
	groups = {snappy = 1, choppy = 3, flammable = 2,snow_cover = 1},
	sounds = default.node_sound_wood_defaults(),
	on_place = minetest.rotate_node,
...
minetest.register_node("default:water_source", {
	...
	groups = {water = 3, liquid = 3, puts_out_fire = 1, inert =1},
})
...
minetest.register_node("default:water_flowing", {
	...
	groups = {water = 3, liquid = 3, puts_out_fire = 1,
		not_in_creative_inventory = 1, inert =1},
})
...
minetest.register_node("default:lava_source", {
	...
	groups = {lava = 3, liquid = 2, hot = 3, igniter = 1, inert =1},
})
...
default.register_chest("chest", {
	...
	groups = {choppy = 2, oddly_breakable_by_hand = 2,snow_cover = 1},
})
...
minetest.register_node("default:bookshelf", {
	...
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3,snow_cover = 1},
	sounds = default.node_sound_wood_defaults(),
...
minetest.register_node("default:glass", {
	...
	sunlight_propagates = true,
	is_ground_content = false,
	groups = {cracky = 3, oddly_breakable_by_hand = 3,snow_cover = 1},
	sounds = default.node_sound_glass_defaults(),
})
