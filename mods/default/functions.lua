...
minetest.register_abm({
	...
	chance = 1,
	action = function(pos)
		minetest.set_node(pos,{name="carts:rail"})
	end
})
minetest.register_abm({
...
default.leafdecay_enable_cache = false
	...
	action = function(p0, node, _, _)
		...
		if not do_preserve then
			...
			for _, itemname in ipairs(itemstacks) do
				if minetest.get_item_group(n0.name, "leafdecay_drop") ~= 0 or itemname ~= n0.name and (itemname == "default:sapling" or itemname == "default:junglesapling" or itemname == "default:pine_sapling") then
					local p_drop = {
