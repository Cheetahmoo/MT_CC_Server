...
minetest.register_craft({
	...
	recipe = {
		{'default:stone', 'default:coal_lump_lump'},
	}
})
minetest.register_craft({
	output = 'default:stone_with_iron',
	recipe = {
		{'default:stone', 'default:iron_lump'},
	}
})
minetest.register_craft({
	output = 'default:stone_with_copper',
	recipe = {
		{'default:stone', 'default:copper_lump'},
	}
})
minetest.register_craft({
...
minetest.register_craft({
	...
	recipe = {
		{'default:stone', 'default:gold_lump'},
	}
})
minetest.register_craft({
	output = 'default:stone_with_diamond',
	recipe = {
		{'default:stone', 'default:diamond'},
	}
})
