...
flowersDry.datas = {
	{"rose_dry", "Dry Rose", {-0.15, -0.5, -0.15, 0.15, 0.3, 0.15}, { not_in_creative_inventory=1}},
	{"tulip_dry", "Dry Orange Tulip",  {-0.15, -0.5, -0.15, 0.15, 0.2, 0.15}, { not_in_creative_inventory=1}},
	{"dandelion_yellow_dry", "Dry Yellow Dandelion", {-0.15, -0.5, -0.15, 0.15, 0.2, 0.15}, { not_in_creative_inventory=1}},
	{"geranium_dry", "Dry Blue Geranium",  {-0.15, -0.5, -0.15, 0.15, 0.2, 0.15}, { not_in_creative_inventory=1}},
	{"viola_dry", "Dry Viola", {-5 / 16, -0.5, -5 / 16, 5 / 16, -1 / 16, 5 / 16}, { not_in_creative_inventory=1}},
	{"dandelion_white_dry", "Dry White dandelion", {-5 / 16, -0.5, -5 / 16, 5 / 16, -2 / 16, 5 / 16}, { not_in_creative_inventory=1}}
}

for _,item in pairs(flowersDry.datas) do
...
flowers.datas = {
	...
	{"viola", "Viola", {-5 / 16, -0.5, -5 / 16, 5 / 16, -1 / 16, 5 / 16}, {color_violet = 1}},
	{"dandelion_white", "White dandelion", {-5 / 16, -0.5, -5 / 16, 5 / 16, -2 / 16, 5 / 16}, {color_white = 1}}
}
...
-- Mushrooms
--
minetest.register_node("flowers:mushroom_red_", {
