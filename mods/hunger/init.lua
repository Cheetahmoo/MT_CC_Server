...
HUNGER_TICK = 200			-- 800 time in seconds after that 1 hunger point is taken
...
HUNGER_EXHAUST_DIG = 2.5		-- exhaustion increased this value after digged node
HUNGER_EXHAUST_PLACE = 1	-- exhaustion increased this value after placed
HUNGER_EXHAUST_MOVE = 4	-- 1.5 exhaustion increased this value if player movement detected
