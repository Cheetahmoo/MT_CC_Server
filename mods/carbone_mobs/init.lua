...
if not minetest.setting_getbool("creative_mode") then -- Disable all mob spawning in creative mode.
	...
	if minetest.setting_getbool("spawn_hostile_mobs") ~= false then -- “If nil or true then”
		...
		carbone_mobs:register_spawn("carbone_mobs:dirt_monster", "a dirt monster",     mn, 2, -1, 10000, 10, 20)
		carbone_mobs:register_spawn("carbone_mobs:stone_monster", "a stone monster",   mn, 3, -1, 6000, 12, 20)
		carbone_mobs:register_spawn("carbone_mobs:sand_monster", "a sand monster",     mn, 1, -1, 10000, 10, 20)
		carbone_mobs:register_spawn("carbone_mobs:oerkki", "an oerkki",                mn, 3, -1, 16000, 14, 20)
		carbone_mobs:register_spawn("carbone_mobs:tree_monster", "a tree monster",     mn, 1, -1, 17000, 12, 20)
		carbone_mobs:register_spawn("carbone_mobs:trooper", "a trooper",               mn, 2, -1, 18000, 12, 20)

		carbone_mobs:register_spawn("carbone_mobs:dungeon_master", "a dungeon master", mn, 1, -1, 22000, 3, -22)
		carbone_mobs:register_spawn("carbone_mobs:rhino", "a rhino",                   mn, 1, -1, 15000, 5, 0)
	end
end
