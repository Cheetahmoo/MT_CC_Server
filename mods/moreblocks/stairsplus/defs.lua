...
local box_slope_outer_onehalf_a = {
	type = "fixed",
	fixed = {
		{-0.5,  -0.5,     0,      0, -0.25, 0.5},
		{-0.5, -0.25, 0.125, -0.125,     0, 0.5},
		{-0.5,     0,  0.25,  -0.25,  0.25, 0.5},
		{-0.5,  0.25, 0.375, -0.375,   0.5, 0.5},
	}
}

local box_slope_outer_onehalf_b = {
	type = "fixed",
	fixed = {
		{-0.5,  -0.5,   -0.5,   0.5, -0.25, 0.5},
		{-0.5, -0.25, -0.375, 0.375,     0, 0.5},
		{-0.5,     0,  -0.25,  0.25,  0.25, 0.5},
		{-0.5,  0.25, -0.125, 0.125,   0.5, 0.5},
	}
}

local box_slope_inner_onehalf_a = {
	type = "fixed",
	fixed = {
		{-0.5,  -0.5,     0,    0.5, -0.25, 0.5},
		{-0.5, -0.25, 0.125,    0.5,     0, 0.5},
		{-0.5,     0,  0.25,    0.5,  0.25, 0.5},
		{-0.5,  0.25, 0.375,    0.5,   0.5, 0.5},
		{-0.5,  -0.5,  -0.5,      0, -0.25, 0.5},
		{-0.5, -0.25,  -0.5, -0.125,     0, 0.5},
		{-0.5,     0,  -0.5,  -0.25,  0.25, 0.5},
		{-0.5,  0.25,  -0.5, -0.375,   0.5, 0.5},
	}
}

local box_slope_inner_onehalf_b = {
	type = "fixed",
	fixed = {
		{-0.5,  -0.5,   -0.5,   0.5, -0.25, 0.5},
		{-0.5, -0.25, -0.375,   0.5,     0, 0.5},
		{-0.5,     0,  -0.25,   0.5,  0.25, 0.5},
		{-0.5,  0.25, -0.125,   0.5,   0.5, 0.5},
		{-0.5, -0.25,   -0.5, 0.375,     0, 0.5},
		{-0.5,     0,   -0.5,  0.25,  0.25, 0.5},
		{-0.5,  0.25,   -0.5, 0.125,   0.5, 0.5},
	}
}
--(END OF ADDITION)--
...
stairsplus.defs = {
	...
	["slope"] = {
		...
		--(ADDED BY JGC 1-23-20)
		["_outer_onehalf_a"] = {
			mesh = "moreblocks_slope_outer_onehalf_a.obj",
			collision_box = box_slope_outer_onehalf_a,
			selection_box = box_slope_outer_onehalf_a,
		},
		["_outer_onehalf_b"] = {
			mesh = "moreblocks_slope_outer_onehalf_b.obj",
			collision_box = box_slope_outer_onehalf_b,
			selection_box = box_slope_outer_onehalf_b,
		},
		["_inner_onehalf_a"] = {
			mesh = "moreblocks_slope_inner_onehalf_a.obj",
			collision_box = box_slope_inner_onehalf_a,
			selection_box = box_slope_inner_onehalf_a,
		},
		["_inner_onehalf_b"] = {
			mesh = "moreblocks_slope_inner_onehalf_b.obj",
			collision_box = box_slope_inner_onehalf_b,
			selection_box = box_slope_inner_onehalf_b,
		},
		--(END OF ADDITION)
	},
	["stair"] = {
