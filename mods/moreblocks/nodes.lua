...
local nodes = {
	["wood_tile"] = {
		...
		groups = {snappy = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 3, snow_cover = 1},
	...
	["tar"] = {
		description = S("Tar"),
		groups = {cracky = 2, tar_block = 1, no_snow_cover = 1},
		sounds = sound_stone,
	},
	["cobble_compressed"] = {
	...
	["iron_glass"] = {
		...
		groups = {snappy = 2, cracky = 3, oddly_breakable_by_hand = 3, snow_cover = 1},
		sounds = sound_glass,
	},
	["coal_glass"] = {
	...
	["empty_bookshelf"] = {
		...
		groups = {snappy = 2, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3, snow_cover = 1},
		sounds = sound_wood,
		no_stairs = true,
	},
	["coal_stone"] = {
	...
	["all_faces_tree"] = {
		...
		groups = {tree = 1,snappy = 1, choppy = 2, oddly_breakable_by_hand = 1, flammable = 2, snow_cover = 1},
		sounds = sound_wood,
		furnace_burntime = 30,
	},
	...
	["rope"] = {
		...
		groups = {snappy = 3, flammable = 2, snow_cover = 1},
		sounds = sound_leaves,
		no_stairs = true,
	},
}
