...
minetest.register_alias("oil_extraction:blight_spot_1", "crop_blight:blight_spot_1")--(1-24-20)
minetest.register_alias("oil_extraction:blight_spot_2", "crop_blight:blight_spot_2")--(1-24-20)
minetest.register_alias("oil_extraction:blight_spot_3", "crop_blight:blight_spot_3")--(1-24-20)